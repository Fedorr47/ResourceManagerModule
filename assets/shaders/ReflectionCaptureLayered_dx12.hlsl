// ReflectionCaptureLayered_dx12.hlsl (Layered: render ALL faces in one pass using SV_RenderTargetArrayIndex)
// Assumes instances are duplicated x6 in order (faces 0..5), i.e. face = (instanceId % 6).
...
float4 PS_ReflectionCaptureLayered(VSOut IN) : SV_Target0
{
